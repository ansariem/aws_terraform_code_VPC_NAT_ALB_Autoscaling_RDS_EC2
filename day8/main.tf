...
module "alb" {
  ...
  instance3_id = "${module.first_ec2_lab.instance3_id}"
  instance4_id = "${module.first_ec2_lab.instance4_id}"
  instance5_id = "${module.first_ec2_lab.instance5_id}"
  instance6_id = "${module.first_ec2_lab.instance6_id}"
...
terraform {
  backend "s3" {
    # Your bucket name!
    bucket         = "ansari-terraform"
    key            = "ansari/day8/terraform.tfstate"
    region         = "us-east-1"
